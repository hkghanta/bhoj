...
import { PaymentScheduleManager } from '@/components/customer/PaymentScheduleManager'
    ...
    <div className="max-w-3xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-extrabold tracking-tight text-text-1">Payment Schedule</h1>
        </div>
        <span className="text-sm text-text-3">{event.event_name}</span>
      </div>

      <PaymentScheduleManager eventId={id} />
    </div>
  )
}
