    ...
    <main className="min-h-screen bg-white font-sans overflow-x-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-12 pt-20 pb-24 sm:pt-28 sm:pb-32 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-6 text-sm text-text-3">
              <span className="flex items-center gap-2"><span className="w-5 h-5 rounded-md bg-green-100 text-green-700 text-[10px] font-black flex items-center justify-center">✓</span> No booking fees</span>
              <span className="flex items-center gap-2"><span className="w-5 h-5 rounded-md bg-green-100 text-green-700 text-[10px] font-black flex items-center justify-center">✓</span> 100% verified</span>
              <span className="flex items-center gap-2"><span className="w-5 h-5 rounded-md bg-green-100 text-green-700 text-[10px] font-black flex items-center justify-center">✓</span> Plan from anywhere</span>
            </div>
          </div>
          <HeroSearch />
        </div>
      ...
      <div className="bg-cream/60 backdrop-blur border-b border-brand-border">
        <div className="max-w-7xl mx-auto flex flex-wrap justify-center gap-8 sm:gap-12 px-6 py-5 text-sm text-text-3">
          <span><strong className="text-text-1 font-black text-lg">26+</strong> service categories</span>
          <span className="w-px bg-brand-border hidden sm:block" />
          <span><strong className="text-text-1 font-black text-lg">100%</strong> compliance-verified</span>
          <span className="w-px bg-brand-border hidden sm:block" />
          <span><strong className="text-text-1 font-black text-lg">Free</strong> — right now</span>
        </div>
      </div>
      ...
      <section className="bg-white py-20 px-6 border-b border-brand-border">
        <div className="max-w-7xl mx-auto text-center">
          <span className="text-[11px] font-black tracking-[0.2em] uppercase text-text-4 mb-6 block">Every celebration, every occasion</span>
      ...
      <section id="how-it-works" className="bg-white py-24 px-6">
        <div className="max-w-6xl mx-auto text-center">
          <span className="text-[11px] font-black tracking-[0.2em] uppercase text-text-3 mb-4 block">How it works</span>
          <h2 className="text-4xl sm:text-5xl font-black text-text-1 tracking-tight mb-4">Plan in 4 simple steps</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-14">
            {[
              ...
              <div key={n} className="relative bg-cream border border-brand-border rounded-2xl p-7 text-left group hover:border-brand/20 hover:shadow-lg hover:shadow-brand/5 transition-all duration-200">
                <div className="absolute -top-3.5 left-6 w-7 h-7 rounded-full bg-brand text-white text-xs font-black flex items-center justify-center shadow-md shadow-brand/20">{n}</div>
                <span className="text-4xl block mb-4 mt-2">{emoji}</span>
                <h3 className="font-black text-text-1 mb-2 text-[15px]">{title}</h3>
                <p className="text-sm text-text-3 leading-relaxed">{desc}</p>
              </div>
            ))}
          </div>
          <Link href="/register/customer" className="inline-block bg-brand text-white text-sm font-black px-10 py-4 rounded-xl hover:bg-brand-hover transition-all duration-200 hover:shadow-lg hover:shadow-brand/25" style={{ boxShadow: "0 4px 20px rgba(232,85,16,0.25)" }}>
            Start planning free →
          </Link>
        </div>
      </section>
      ...
      <section className="bg-cream py-24 px-6 border-t border-brand-border">
        <div className="max-w-6xl mx-auto text-center">
          <span className="text-[11px] font-black tracking-[0.2em] uppercase text-text-3 mb-4 block">Featured vendors</span>
          <h2 className="text-4xl sm:text-5xl font-black text-text-1 tracking-tight mb-4">Top-matched vendors this week</h2>
            ...
            {VENDOR_CARDS.map(({ img, alt, badge, category, name, meta, stars, match }) => (
              <div key={name} className="bg-white border border-brand-border rounded-2xl overflow-hidden group hover:-translate-y-1.5 hover:shadow-xl hover:shadow-black/5 transition-all duration-300 cursor-pointer text-left">
                <div className="relative h-40 overflow-hidden">
                  ...
                  {badge && (
                    <div className="absolute top-3 left-3 bg-brand text-white text-[9px] font-black px-3 py-1 rounded-full tracking-wider uppercase shadow-md">{badge}</div>
                  )}
                </div>
                <div className="p-5">
                  <div className="text-[10px] font-black uppercase tracking-[0.15em] text-text-4 mb-1.5">{category}</div>
                  <div className="text-[15px] font-black text-text-1 mb-0.5">{name}</div>
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-brand-border/60">
                    ...
                    <span className="text-[10px] font-black text-brand bg-brand/5 border border-brand/15 px-2.5 py-1 rounded-full">{match}</span>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="bg-white py-24 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            <span className="text-[11px] font-black tracking-[0.2em] uppercase text-text-3 mb-4 block">Compare & Save</span>
            <h2 className="text-4xl sm:text-5xl font-black text-text-1 tracking-tight leading-[1.05] mb-5">Small gathering or big.<br />Always the best value.</h2>
            ...
            <Link href="/register/customer" className="inline-block bg-brand text-white text-sm font-black px-8 py-4 rounded-xl hover:bg-brand-hover transition-all duration-200 hover:shadow-lg hover:shadow-brand/25" style={{ boxShadow: "0 4px 20px rgba(232,85,16,0.25)" }}>
          ...
          <div className="bg-white border border-brand-border rounded-3xl overflow-hidden shadow-2xl shadow-black/5">
            ...
            <div className="p-4 flex flex-col gap-3">
              ...
              <div className="relative bg-white border-2 border-brand rounded-2xl px-5 py-4" style={{ boxShadow: "0 0 0 4px rgba(232,85,16,0.06)" }}>
                <div className="absolute -top-2.5 left-5 bg-brand text-white text-[9px] font-black px-2.5 py-0.5 rounded-full uppercase tracking-wider">Best Value</div>
                <div className="flex items-center justify-between gap-3 mt-1">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-black text-text-1">Spice Garden New York</div>
                      <div className="text-[11px] text-text-4">Halal · 6 cuisines · 98% match</div>
                    </div>
                  </div>
                  <div className="text-right flex-shrink-0">
                    <div className="text-xs text-text-3">★ 4.9 · 86</div>
                    <div className="text-lg font-black text-text-1">$28<span className="text-xs font-normal text-text-4">/head</span></div>
                  </div>
                  <button className="bg-brand text-white text-xs font-black px-4 py-2 rounded-xl flex-shrink-0 shadow-md shadow-brand/20">Select →</button>
                </div>
              </div>
              {[
                ...
                <div key={name} className="bg-white border border-brand-border rounded-2xl px-5 py-4 flex items-center justify-between gap-3 hover:border-brand/20 transition-colors">
                  ...
                  <div className="text-right flex-shrink-0">
                    ...
                    <div className="text-lg font-black text-text-1">{price}<span className="text-xs font-normal text-text-4">/head</span></div>
                  </div>
      ...
      <section className="relative bg-cream py-24 px-6 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl font-black text-text-1 tracking-tight leading-[1.05] mb-5">Smart matching.<br />Real results.</h2>
            ...
            <Link href="/#how-it-works" className="inline-block bg-brand text-white text-sm font-black px-8 py-4 rounded-xl hover:bg-brand-hover transition-all duration-200 hover:shadow-lg hover:shadow-brand/25" style={{ boxShadow: "0 4px 20px rgba(232,85,16,0.25)" }}>
              See how it works →
            </Link>
          </div>
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div key={label} className="bg-white border border-brand-border rounded-2xl p-8 hover:shadow-lg hover:shadow-black/5 transition-all duration-200">
                <div className={`text-4xl sm:text-5xl font-black tracking-tight leading-none mb-2 ${accent ? "text-brand" : "text-text-1"}`}>{n}</div>
      ...
      <section className="bg-white py-24 px-6 border-t border-brand-border">
        <div className="max-w-6xl mx-auto text-center">
          <span className="text-[11px] font-black tracking-[0.2em] uppercase text-text-3 mb-4 block">Why OneSeva</span>
          <h2 className="text-4xl sm:text-5xl font-black text-text-1 tracking-tight mb-4">Everything in one place</h2>
      ...
      <section className="border-t border-brand-border">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="bg-white border-r border-brand-border px-8 sm:px-14 py-20">
            <span className="text-[11px] font-black tracking-[0.2em] uppercase text-text-3 mb-4 block">Planning an event?</span>
            <h3 className="text-3xl font-black text-text-1 tracking-tight mb-4">Your full celebration platform</h3>
            ...
            <Link href="/register/customer" className="inline-flex items-center gap-2 bg-brand text-white text-sm font-black px-8 py-4 rounded-xl hover:bg-brand-hover transition-all duration-200 hover:shadow-lg hover:shadow-brand/25" style={{ boxShadow: "0 4px 20px rgba(232,85,16,0.25)" }}>
              Start planning free →
            </Link>
          </div>
          ...
          <div className="px-8 sm:px-14 py-20" style={{ background: "linear-gradient(165deg, #1e0f07, #2a1810)" }}>
            <span className="text-[11px] font-black tracking-[0.2em] uppercase block mb-4" style={{ color: "rgba(255,255,255,0.35)" }}>Running a business?</span>
            <h3 className="text-3xl font-black text-white tracking-tight mb-4">More leads. Zero missed orders.</h3>
            ...
            <Link href="/for-vendors" className="inline-flex items-center gap-2 text-sm font-black px-8 py-4 rounded-xl transition-all duration-200" style={{ background: "#e85510", color: "#fff", boxShadow: "0 4px 20px rgba(232,85,16,0.4)" }}>
      ...
      <section className="bg-cream py-24 px-6">
        <div className="max-w-6xl mx-auto text-center">
          <span className="text-[11px] font-black tracking-[0.2em] uppercase text-text-3 mb-4 block">Real stories</span>
          <h2 className="text-4xl sm:text-5xl font-black text-text-1 tracking-tight mb-4">Trusted by families across the US</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {TESTIMONIALS.map(({ text, name, detail, avatar, vendorCard }) => (
              ...
              >
                {vendorCard && (
                  <div className="absolute -top-2.5 left-6 bg-brand text-white px-2.5 py-0.5 text-[9px] font-black uppercase tracking-wider rounded-full">Vendor</div>
                )}
                ...
                <div className="flex items-center gap-3 pt-5 border-t border-brand-border/60">
                  <div
                    className="w-10 h-10 rounded-full text-sm font-black flex items-center justify-center flex-shrink-0"
      ...
      <section className="bg-white py-24 px-6 border-t border-brand-border">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl font-black text-text-1 tracking-tight leading-[1.05] mb-5">Every vendor.<br />Any city.</h2>
            ...
            <Link href="/#categories" className="inline-block bg-brand text-white text-sm font-black px-8 py-4 rounded-xl hover:bg-brand-hover transition-all duration-200 hover:shadow-lg hover:shadow-brand/25" style={{ boxShadow: "0 4px 20px rgba(232,85,16,0.25)" }}>
      ...
      <section className="relative bg-white py-24 px-6 text-center overflow-hidden">
        ...
        <div className="relative">
          ...
          <h2 className="text-4xl sm:text-5xl font-black text-text-1 tracking-tight mb-5 mt-2">Start planning your<br />celebration today.</h2>
          ...
          <div className="flex gap-4 justify-center flex-wrap mb-5">
            <Link href="/register/customer" className="inline-flex items-center gap-2 bg-brand text-white text-sm font-black px-10 py-4 rounded-xl hover:bg-brand-hover transition-all duration-200 hover:shadow-xl hover:shadow-brand/25" style={{ boxShadow: "0 6px 24px rgba(232,85,16,0.3)" }}>
              Plan my event →
            </Link>
            <Link href="/for-vendors" className="inline-flex items-center gap-2 bg-white text-text-1 text-sm font-black px-10 py-4 rounded-xl border-2 border-brand-border hover:border-brand/30 hover:shadow-lg transition-all duration-200">
              List my business →
            </Link>
          </div>
