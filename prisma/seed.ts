...
async function main() {
  ...
  if (!existingItems) {
    const dishData = [
      ...
      { name: 'Garlic Naan', category: MenuCategory.BREAD, spice_level: SpiceLevel.NONE, is_vegetarian: true, is_vegan: false, is_jain: false, is_halal: true, contains_nuts: false, contains_gluten: true, contains_dairy: true, contains_eggs: false, contains_soy: false, contains_shellfish: false, description: 'Freshly baked leavened bread with garlic butter' },
      { name: 'Gulab Jamun', category: MenuCategory.DESSERT, spice_level: SpiceLevel.NONE, is_vegetarian: true, is_vegan: false, is_jain: false, is_halal: true, contains_nuts: false, contains_gluten: true, contains_dairy: true, contains_eggs: false, contains_soy: false, contains_shellfish: false, description: 'Soft milk dumplings in rose syrup' },
